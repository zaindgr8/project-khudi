        ...
        <div className={`col col-lg-4 col-12 ${props.blLeft}`}>
            <div className="tp-blog-sidebar">
                ...
                <div className="widget category-widget">
                    <h3>Categories</h3>
                    <ul>
                        <li><Link href="/blog-single/Best-and-less-published-their-supplier-lists.">Helping Poor</Link></li>
                        <li><Link href="/blog-single/Best-and-less-published-their-supplier-lists.">Water Problem</Link></li>
                        <li><Link href="/blog-single/Best-and-less-published-their-supplier-lists.">Charity</Link></li>
                        <li><Link href="/blog-single/Best-and-less-published-their-supplier-lists.">Medical Campain</Link></li>
                        <li><Link href="/blog-single/Best-and-less-published-their-supplier-lists.">Free Food</Link></li>
                    </ul>
                </div>
