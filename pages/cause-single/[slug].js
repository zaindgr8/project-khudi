...
const CaseSinglePage = () => {
    ...
    const caseDetails = Causes.find(item => item.slug === router.query.slug)
    ...
    return (
        <Fragment>
            <Navbar />
            <PageTitle pageTitle={caseDetails?.cTitle} pagesub={caseDetails?.cTitle} />
                                ...
                                <div className="tp-case-details-text">
                                    <div id="Description">
                                        <div className="tp-case-details-img">
                                            <Image src={caseDetails?.cImgSingle} alt="" />
                                        </div>
                                        <div className="tp-case-content">
                                            <div className="tp-case-text-top">
                                                ...
                                                <div className="submit-area sub-btn">
                                                    <Link href="/donate" className="theme-btn submit-btn">Donate Now</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                <div className="comment-wrapper">
                                                                    ...
                                                                    <div className="comment-area">
                                                                        ...
                                                                        <div className="comments-reply">
                                                                            <Link className="comment-reply-link" href="/cause-single/Financial-Help-for-Poor-Families"><i className="fa fa-reply" aria-hidden="true"></i><span>Reply</span></Link>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div className="comment-main-area">
                                                                        <div className="comment-wrapper">
                                                                            ...
                                                                            <div className="comment-area">
                                                                                <p>I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, </p>
                                                                                <div className="comments-reply">
                                                                                    <Link className="comment-reply-link" href="/cause-single/Financial-Help-for-Poor-Families"><span><i className="fa fa-reply" aria-hidden="true"></i> Reply</span></Link>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
